...
class GuestImportFlowTest < ActionDispatch::IntegrationTest
  ...
  test "homepage offers an explicit build form and example selectors" do
    ...
    assert_select ".lp-hero h1", text: "Turn any video into a language lesson"
    assert_select ".lp-hero .lp-supported", text: "Supported languages: Spanish, French, Hebrew, Arabic, Russian"
