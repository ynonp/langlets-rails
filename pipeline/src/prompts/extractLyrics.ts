// Instruction prompt for the lyrics call: Gemini watches the YouTube clip and
// returns the plain lyrics/transcript text, one sung or spoken line per output
// line. Word timing does NOT come from this call — the returned text is force-
// aligned to the audio by ElevenLabs afterwards — so the only job here is
// getting the words and their line breaks right.
