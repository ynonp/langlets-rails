...
class CoursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "signed-in homepage shows the user menu and highlighted daily vocabulary practice" do
    ...
    assert_select "[data-testid='daily-vocab-nav']" do
      assert_select "span", text: "Daily Vocab Practice"
      assert_select "span[aria-label='0 day streak']", text: "0"
    end
  ...
  test "homepage presents the product image before Try now without a duplicate creation section" do
    ...
    assert_select "header.lp-hero h1", text: "Turn any video into a language lesson"
    assert_select "header.lp-hero .lp-supported", text: "Supported languages: Spanish, French, Hebrew, Arabic, Russian"
